...
TOKEN = os.environ.get("8503812037:AAFu6zCSez0ro9NIFJX65v2r_9MvLEiDbgQ")
ADMIN_ID = int(os.environ.get("1179345537", "0"))
CHANNEL_ID = os.environ.get("@ar_downloader") # e.g. @YourChannel
APP_URL = os.environ.get("https://arsycoxxx-cell.github.io/AR/") # Your GitHub Pages Link
TMDB_KEY = os.environ.get("19241042e5671d4369263a2b6f8e7ff5")
NEWS_KEY = os.environ.get("pub_114d737697a4438e977f933d8342f495")
...
async def auto_post_loop(context: ContextTypes.DEFAULT_TYPE):
    # Runs every 4 hours to fill channel with content
    while True:
        try:
